...
import com.vaccinationapp.Adapters.AdminCancelAdapter;
import com.vaccinationapp.Models.BookingPojo;

import java.util.ArrayList;
import java.util.List;

public class AdminCancelApointmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_cancel_apointments);
    ...
    private void getTripDetails() {
        ...
        progressDialog = new ProgressDialog(AdminCancelApointmentsActivity.this);
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (viewrequests.getStatus().equals("Cancelled")) {
                        viewBookingPojo.add(viewrequests);
                    }

                }
                if (viewBookingPojo.size() > 0) {
                    list_view.setAdapter(new AdminCancelAdapter( AdminCancelApointmentsActivity.this,viewBookingPojo));
                }
            } else {
                Toast.makeText(AdminCancelApointmentsActivity.this, "No Bookings Found", Toast.LENGTH_SHORT).show();
            }
        }
