...
import com.vaccinationapp.Adapters.MyPendingsAdapter;
import com.vaccinationapp.Models.BookingPojo;

import java.util.ArrayList;
import java.util.List;

public class MyPendingApoinmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_pending_apoinments);
        ...
        Toast.makeText(MyPendingApoinmentsActivity.this, username, Toast.LENGTH_SHORT).show();

    }
    private void getMyBookingsDetails() {
        viewBookingPojo = new ArrayList<>();
        progressDialog = new ProgressDialog(MyPendingApoinmentsActivity.this);
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                if (viewBookingPojo.size() > 0) {
                    list_view.setAdapter(new MyPendingsAdapter( MyPendingApoinmentsActivity.this,viewBookingPojo));
                }
            } else {
                Toast.makeText(MyPendingApoinmentsActivity.this, "No Bookings Found", Toast.LENGTH_SHORT).show();
            }
        }
